...
export default function AppHeader({ initials, label }: { initials: string; label: string }) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center gap-6 border-b border-line bg-white/88 px-6 backdrop-blur-md">
      <Link href="/" className="flex items-center gap-[11px]">
        ...
        <div className="text-[13.5px] font-bold tracking-tight text-ink">SSC Product OS</div>
      </Link>
      <NavTabs />
